...
<link rel="stylesheet"
  ...
  <script src="//code.jquery.com/jquery-1.10.2.js"></script>
    ...
    <link href="attendance/bootstrap.css" rel="stylesheet" /> 
    <script type="text/javascript" src="attendance/bootstrap.min.js"></script> 
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="student.php" class="logo">
      ...
      <span class="logo-lg"><b>Student</b>LTE</span>
    </a>
         ...
         <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                echo '
                <tr>
                  <td>Class</td><td>'.$userRow9[0]["Class"].'</td></tr>
                  <td>Admission No</td><td>'.$userRow9[0]["Admission_No"].'</td></tr>
                  <td>Name</td><td>'.$userRow9[0]["Student_name"].'</td></tr>
                  <td>DOB</td><td>'.$userRow9[0]["DOB"].'</td></tr>
                  <td>Father Name</td><td>'.$userRow9[0]["Fathers_name"].'</td></tr>
                  <td>Mother Name</td><td>'.$userRow9[0]["Mothers_name"].'</td></tr>
                  <td>Contact</td><td>'.$userRow9[0]["Contact_No"].'</td></tr>
                  <td>Address</td><td>'.$userRow9[0]["Address"].'</td></tr>
