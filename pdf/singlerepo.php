...
// replace getclass refer 6,350
//line 369 , update basic information for student
...
While($row = mysql_fetch_array($basic)) {
	...
	$Student_name='Anshika Malik';
    $basic_info=array($Student_name,'Mr. Amit Malik','Mrs. Renu Malik','2009-07-21',3,'B',$Admission_No);
	//$basic_info=array($Student_name,$Fathers_name,$Mothers_name,$DOB,$Class_no,$Section,$Admission_No);
	include('queries.php');

	$pdf->BuildTable($count,$basic_info,$other_info,$marks,$marks2,3955,$Class);
