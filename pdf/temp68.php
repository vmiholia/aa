  ...
  //  $this->SetFont('Arial','I',8);
   ...
   // $this->Cell(0,16,'Page '.$this->PageNo().'/{nb}',0,0,'R');
	...
	function BuildTable($count,$basic_info,$other_info,$marks,$marks2) {
		...
		$mo=(round($marks[5][0])+round($marks[5][1])+round($marks[5][2])+round($marks[5][3]));
		$this->Cell(40,6,'SANSKRIT','LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[5][0]),'LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[5][1]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[5][2]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[5][3]),'LBTR',0,'C',1);
		$this->Cell(27,6,$mo,'LBTR',0,'C',1);
		$this->Cell(26,6,$marks2[4][0],'LBTR',1,'C',1);

		$mo=(round($marks[4][0])+round($marks[4][1])+round($marks[4][2])+round($marks[4][3]));

		$this->Cell(40,6,'SOCIAL SCIENCE','LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[4][0]),'LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[4][1]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[4][2]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[4][3]),'LBTR',0,'C',1);
		$this->Cell(27,6,$mo,'LBTR',0,'C',1);
		$this->Cell(26,6,$marks2[4][0],'LBTR',1,'C',1);
		
		$mo=(round($marks[3][0])+round($marks[3][1])+round($marks[3][2])+round($marks[3][3]));
		$this->Cell(40,6,'SCIENCE','LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[3][0]),'LTBR',0,'C',1);
		$this->Cell(27,6,round($marks[3][1]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[3][2]),'LBTR',0,'C',1);
		$this->Cell(27,6,round($marks[3][3]),'LBTR',0,'C',1);
		$this->Cell(27,6,$mo,'LBTR',0,'C',1);
		$this->Cell(26,6,$marks2[3][0],'LBTR',1,'C',1);
		...
		$this->Cell(165,6,'Work Education(or Pre-vocational Education','LBTR',0,'L',1);
			...
			$this->Cell(36,6,strip_tags($marks2[9][0]),'BLTR',1,'C',1);
