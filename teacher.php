...
<head>
  ...
  <title>Teacher 2 | Dashboard</title>
        ...
        var myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [
            {
              ...
              backgroundColor:'rgba(48, 4,102,0.5)',
              borderColor:'rgba(48, 4,102,1)',
            ...
            },
            {
              ...
              backgroundColor:'rgba(75,255, 2, 0.5)',
              borderColor:'rgba(75, 255, 2, 1)',
              borderWidth: 1
            }]
          },
          options: {
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../attendance/class_attendance.php"><i class="fa fa-circle-o"></i> Overall</a></li>
      ...
      <div class="row">
        <div class="col-lg-6 col-xs-12">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="teacher_student_information.php" class="small-box-footer">CLick Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-6 col-xs-12">
          ...
          <div class="small-box bg-red">
            ...
            <a href="teacher_teacher_information.php" class="small-box-footer">CLick Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
      <div class="row">
