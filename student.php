      ...
      <div class="row">
        <div class="col-lg-6 col-xs-12">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="student_profile.php" class="small-box-footer">CLick Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-6 col-xs-12">
          ...
          <div class="small-box bg-red">
            ...
            <a href="student_teacher_information.php" class="small-box-footer">CLick Here <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  <p class="text-center">
                    ...
                    <script type="text/javascript" src="attendance/calendermap3.js"></script>
                </div>
              <!-- /.chart-responsive -->
              </div>
              <!-- /.col -->
