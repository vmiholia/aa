    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="graphs/q11.php"><i class="fa fa-circle-o"></i> Teacher</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Student</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> Teacher</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> Student</a></li>
