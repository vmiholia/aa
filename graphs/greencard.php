...
<th colspan="8">ENGLISH READING SKILL</th>
<th colspan="16">ENGLISH WRITING SKILL</th>
<th colspan="8">ENGLISH SPEAKING SKILL</th>
<th colspan="4">ENGLISH LISTENING SKILL</th>
<th colspan="8">HINDI READING SKILL</th>
<th colspan="16">HINDI WRITING SKILL</th>
<th colspan="8">HINDI SPEAKING SKILL</th>
<th colspan="4">HINDI LISTENING SKILL</th>
<th colspan="16">MATHEMATICS</th>
<th colspan="22">OTHERS</th>
...
<tr>
   ...
   <th></th>
   <th></th>
   <th colspan="2">PRONUNCIATION & FLUENCY(PT-1)</th>
   <th colspan="2">PRONUNCIATION & FLUENCY(PT-2)</th>
   <th colspan="2">COMPREHENSION(PT-1)</th>
   <th colspan="2">COMPREHENSION(PT-2)</th>

   <th colspan="2">LITERATURE(PT-1)</th>
   <th colspan="2">LITERATURE(PT-2)</th>
      <th colspan="2">GRAMMAR(PT-1)</th>
   <th colspan="2">GRAMMAR(PT-2)</th>
      <th colspan="2">DICTATION/VOCABULARY(PT-1)</th>
   <th colspan="2">DICTATION/VOCABULARY(PT-2)</th>
   <th colspan="2">HAND WRITING & ASSIGNMENT(PT-1)</th>
   <th colspan="2">HAND WRITING & ASSIGNMENT(PT-2)</th>

   <th colspan="2">RECITAION/STORY TELLING(PT-1)</th>
      <th colspan="2">RECITAION/STORY TELLING(PT-2)</th>
   <th colspan="2">CONVERSATION(PT-1)</th>
   <th colspan="2">CONVERSATION(PT-2)</th>
   ...
   <th colspan="2">DICTATION/VOCABULARY(PT-1)</th>
      <th colspan="2">DICTATION/VOCABULARY(PT-2)</th>
   <th colspan="2">HAND WRITING & ASSIGNMENTS(PT-1)</th>
   <th colspan="2">HAND WRITING & ASSIGNMENTS(PT-2)</th>
   
   <th colspan="2">"RECITATION/STORY TELLING(PT-1)</th>
      <th colspan="2">"RECITATION/STORY TELLING(PT-2)</th>
   <th colspan="2">CONVERSATION(PT-1)</th>
   <th colspan="2">CONVERSATION(PT-2)</th>
   ...
   <th colspan="2">CONCEPT (W)(PT-1)</th>
   <th colspan="2">CONCEPT (W)(PT-2)</th>
      <th colspan="2">ACTIVITY(PT-1)</th>
   <th colspan="2">ACTIVITY(PT-2)</th>
   <th colspan="2">TABLE/MENTAL ABILITY(PT-1)</th>
   <th colspan="2">TABLE/MENTAL ABILITY(PT-2)</th>
      <th colspan="2">CLASS & HOME ASSIGNMENTS(PT-1)</th>
   <th colspan="2">CLASS & HOME ASSIGNMENTS(PT-2)</th>
   
   <th colspan="2">E.V.S.(PT-1)</th>
   <th colspan="2">E.V.S.(PT-2)</th>
   
   <th colspan="2">ACTIVITY/PROJECT(PT-1)</th>
   <th colspan="2">ACTIVITY/PROJECT(PT-2)</th>
   
   <th colspan="2">G.K.(PT-1)</th>
   <th colspan="2">G.K.(PT-2)</th>
   
   <th colspan="2">COMP(PT-1)</th>
   <th colspan="2">COMP(PT-2)</th>
   
   <th colspan="2">DRAWING(PT-1)</th>
   <th colspan="2">DRAWING(PT-2)</th>
   
   <th colspan="1">VALUE EDUCATION(PT-1)</th>
   <th colspan="1">VALUE EDUCATION(PT-2)</th>
...
<th>'.$row1["PT_1_remark"].'</th>
<th> '.$row1["PT_1GRADE"].'</th>
<th>'.$row1["PT_2_remark"].'</th>
<th> '.$row1["PT_2GRADE"].'</th>

<th>'.$row2["PT_1_remark"].'</th>
<th> '.$row2["PT_1GRADE"].'</th>
<th>'.$row2["PT_2_remark"].'</th>
<th> '.$row2["PT_2GRADE"].'</th>

<th>'.$row3["PT_1_remark"].'</th>
<th> '.$row3["PT_1GRADE"].'</th>
<th>'.$row3["PT_2_remark"].'</th>
<th> '.$row3["PT_2GRADE"].'</th>

<th>'.$row4["PT_1_remark"].'</th>
<th> '.$row4["PT_1GRADE"].'</th>
<th>'.$row4["PT_2_remark"].'</th>
<th> '.$row4["PT_2GRADE"].'</th>

<th>'.$row5["PT_1_remark"].'</th>
<th> '.$row5["PT_1GRADE"].'</th>
<th>'.$row5["PT_2_remark"].'</th>
<th> '.$row5["PT_2GRADE"].'</th>

<th>'.$row6["PT_1_remark"].'</th>
<th> '.$row6["PT_1GRADE"].'</th>
<th>'.$row6["PT_2_remark"].'</th>
<th> '.$row6["PT_2GRADE"].'</th>

<th>'.$row7["PT_1_remark"].'</th>
<th> '.$row7["PT_1GRADE"].'</th>
<th>'.$row7["PT_2_remark"].'</th>
<th> '.$row7["PT_2GRADE"].'</th>

<th>'.$row8["PT_1_remark"].'</th>
<th> '.$row8["PT_1GRADE"].'</th>
<th>'.$row8["PT_2_remark"].'</th>
<th> '.$row8["PT_2GRADE"].'</th>

<th>'.$row9["PT_1_remark"].'</th>
<th> '.$row9["PT_1GRADE"].'</th>
<th>'.$row9["PT_2_remark"].'</th>
<th> '.$row9["PT_2GRADE"].'</th>

<th>'.$row10["PT_1_remark"].'</th>
<th> '.$row10["PT_1GRADE"].'</th>
<th>'.$row10["PT_2_remark"].'</th>
<th> '.$row10["PT_2GRADE"].'</th>

<th>'.$row11["PT_1_remark"].'</th>
<th> '.$row11["PT_1GRADE"].'</th>
<th>'.$row11["PT_2_remark"].'</th>
<th> '.$row11["PT_2GRADE"].'</th>

<th>'.$row12["PT_1_remark"].'</th>
<th> '.$row12["PT_1GRADE"].'</th>
<th>'.$row12["PT_2_remark"].'</th>
<th> '.$row12["PT_2GRADE"].'</th>

<th>'.$row13["PT_1_remark"].'</th>
<th> '.$row13["PT_1GRADE"].'</th>
<th>'.$row13["PT_2_remark"].'</th>
<th> '.$row13["PT_2GRADE"].'</th>

<th>'.$row14["PT_1_remark"].'</th>
<th> '.$row14["PT_1GRADE"].'</th>
<th>'.$row14["PT_2_remark"].'</th>
<th> '.$row14["PT_2GRADE"].'</th>

<th>'.$row15["PT_1_remark"].'</th>
<th> '.$row15["PT_1GRADE"].'</th>
<th>'.$row15["PT_2_remark"].'</th>
<th> '.$row15["PT_2GRADE"].'</th>

<th>'.$row16["PT_1_remark"].'</th>
<th> '.$row16["PT_1GRADE"].'</th>
<th>'.$row16["PT_2_remark"].'</th>
<th> '.$row16["PT_2GRADE"].'</th>

<th>'.$row17["PT_1_remark"].'</th>
<th> '.$row17["PT_1GRADE"].'</th>
<th>'.$row17["PT_2_remark"].'</th>
<th> '.$row17["PT_2GRADE"].'</th>

<th>'.$row18["PT_1_remark"].'</th>
<th> '.$row18["PT_1GRADE"].'</th>
<th>'.$row18["PT_2_remark"].'</th>
<th> '.$row18["PT_2GRADE"].'</th>

<th>'.$row19["PT_1_remark"].'</th>
<th> '.$row19["PT_1GRADE"].'</th>
<th>'.$row19["PT_2_remark"].'</th>
<th> '.$row19["PT_2GRADE"].'</th>

<th>'.$row20["PT_1_remark"].'</th>
<th> '.$row20["PT_1GRADE"].'</th>
<th>'.$row20["PT_2_remark"].'</th>
<th> '.$row20["PT_2GRADE"].'</th>

<th>'.$row21["PT_1_remark"].'</th>
<th> '.$row21["PT_1GRADE"].'</th>
<th>'.$row21["PT_2_remark"].'</th>
<th> '.$row21["PT_2GRADE"].'</th>

<th>'.$row22["PT_1_remark"].'</th>
<th> '.$row22["PT_1GRADE"].'</th>
<th>'.$row22["PT_2_remark"].'</th>
<th> '.$row22["PT_2GRADE"].'</th>

<th>'.$row23["PT_1_remark"].'</th>
<th> '.$row23["PT_1GRADE"].'</th>
<th>'.$row23["PT_2_remark"].'</th>
<th> '.$row23["PT_2GRADE"].'</th>

<th>'.$row24["PT_1_remark"].'</th>
<th> '.$row24["PT_1GRADE"].'</th>
<th>'.$row24["PT_2_remark"].'</th>
<th> '.$row24["PT_2GRADE"].'</th>

<th>'.$row25["PT_1_remark"].'</th>
<th> '.$row25["PT_1GRADE"].'</th>
<th>'.$row25["PT_2_remark"].'</th>
<th> '.$row25["PT_2GRADE"].'</th>

<th>'.$row26["PT_1_remark"].'</th>
<th> '.$row26["PT_1GRADE"].'</th>
<th>'.$row26["PT_2_remark"].'</th>
<th> '.$row26["PT_2GRADE"].'</th>

<th>'.$row27["PT_1_remark"].'</th>
<th> '.$row27["PT_1GRADE"].'</th>
...
$query1="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'English' order by Student_Name;";
$query2="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'Hindi' order by Student_Name ;";
$query3="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'Maths' order by Student_Name ;";
$query4="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'EVS' order by Student_Name ;";
$query5="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'GK' order by Student_Name;";
$query6="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'Drawing' order by Student_Name ;";
$query7="select * from LFPSREPORTCARD35GSNEWT WHERE Class='".$class."' AND Subject = 'Computer' order by Student_Name ;";
...
$query="select ROLLNO,attendance,admno from LFPS68FINALD WHERE Class='".$class."' AND Subject = 'English' order by Student_Name;";
$basic = mysql_query($query);
if (false === $basic) {
  echo mysql_error();
}
...
$query1="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'English' order by Student_Name;";
$query2="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Hindi' order by Student_Name ;";
$query3="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Maths' order by Student_Name ;";
$query4="select id,id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Sanskrit' order by Student_Name ;";
$query5="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Science' order by Student_Name ;";
$query6="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Social Studies' order by Student_Name ;";
$query7="select id,id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'GK' order by Student_Name;";
$query8="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Drawing' order by Student_Name ;";
$query9="select id,Adm_No,Student_Name,PT_1*2 as PT_1,PT_2*2 as PT_2,PT,NS_1,SEA_1,Half_Yearly,MARKS_OBTAINED,GRADE from LFPSREPORTCARD68GSNEWT WHERE Class='".$class."' AND Subject = 'Computer' order by Student_Name ;";
...
$q3 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'English'  order by Student_Name;";
$r3 = mysql_query($q3);
if (false === $r3) {
  echo mysql_error();
}
$q4 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Hindi'  order by Student_Name;";
$r4 = mysql_query($q4);
if (false === $r4) {
  echo mysql_error();
}
$q5 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Maths'  order by Student_Name;";
$r5 = mysql_query($q5);
if (false === $r5) {
  echo mysql_error();
}
$q6 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Sanskrit'  order by Student_Name;";

$r6 = mysql_query($q6);
if (false === $r6) {
  echo mysql_error();
}
$q7 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject ='Science'  order by Student_Name;";
$r7 = mysql_query($q7);
if (false === $r7) {
  echo mysql_error();
}
$q8 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Social Studies'  order by Student_Name;";

$r8 = mysql_query($q8);
if (false === $r8) {
  echo mysql_error();
}
$q9 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'GK'  order by Student_Name;";
$r9 = mysql_query($q9);
if (false === $r9) {
  echo mysql_error();
}
$q10 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Drawing'  order by Student_Name;";
$r10 = mysql_query($q10);
if (false === $r10) {
  echo mysql_error();
}
$q11 = "select * from  LFPSREPORTCARD5GSNEWT WHERE Class='".$class."' AND Subject = 'Computer'  order by Student_Name;";
$r11 = mysql_query($q11);
if (false === $r11) {
  echo mysql_error();
}
