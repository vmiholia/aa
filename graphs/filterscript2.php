...
if(isset($_GET['classes']))
{
  ...
  case
      ...
      WHEN fullname LIKE 'Hindi%%'

        THEN 'Hindi'

       WHEN fullname LIKE 'English%%'

        THEN 'English'

       WHEN fullname LIKE 'Maths%%'

        THEN 'Maths'

      WHEN fullname LIKE 'Social Studies%%'

        THEN 'Social Studies'

       WHEN fullname LIKE 'Sanskrit%%'

        THEN 'Sanskrit'

      WHEN fullname LIKE 'Science%%'

        THEN 'Science'
        
	  WHEN fullname LIKE 'EVS%%'

        THEN 'EVS'
        
	  WHEN fullname LIKE 'GK%%'

        THEN 'GK'
        
	  WHEN fullname LIKE 'Drawing%%'

        THEN 'Drawing'
        
	  WHEN fullname LIKE 'Moral Values%%'

        THEN 'Moral Values'
        
	  WHEN fullname LIKE 'Computer%%'
...
where  cc.id = '16'  and ra.roleid ='5' and c.id NOT in('631' , '632') and c.fullname LIKE '%%".$classs."' and c.fullname NOT in('Little Flowers' , 
